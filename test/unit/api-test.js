define([
    ...
    QUnit.skip('extends Events', function(assert) {
    ...
    QUnit.skip('api.trigger works', function(assert) {
        var api = createApi('player');
        var check = false;
        function update() {
            check = true;
    ...
    QUnit.skip('api.off works', function(assert) {
        var api = createApi('player');
        var check = false;
        function update() {
            check = true;
    ...
    QUnit.skip('bad events don\'t break player', function(assert) {
    ...
    QUnit.skip('throws exceptions when debug is true', function(assert) {
        window.jwplayer = window.jwplayer || {};
    ...
    QUnit.skip('rendering mode is html5', function(assert) {
        var api = createApi('player');

        assert.equal(api.getRenderingMode(), 'html5', 'api.getRenderingMode() returns "html5"');
    });

    QUnit.skip('can be removed and reused', function(assert) {
    ...
    QUnit.skip('replaces and restores container', function(assert) {
    ...
    QUnit.skip('event dispatching', function(assert) {
        var api = createApi('player');
        var originalEvent = {
            type: 'original'
        };
    ...
    QUnit.skip('defines expected methods', function(assert) {
        var api = createApi('player');
    ...
    QUnit.skip('defines expected members', function(assert) {
        var api = createApi('player');
    ...
    QUnit.skip('does not contain unexpected members or methods', function(assert) {
        var api = createApi('player');
    ...
    QUnit.skip('has chainable methods', function(assert) {
        var api = createApi('player');
    ...
    QUnit.skip('has methods that can only be called after setup', function(assert) {
        ...
        api.setup(config).on('ready', function(e) {
            ...
            if (BROWSER_SUPPORTS_VIDEO) {
                ...
                assert.ok(/buffering|playing/.QUnit.skip(state),
